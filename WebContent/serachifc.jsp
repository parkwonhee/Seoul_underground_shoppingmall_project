...
<body>
	...
	<div class="form">
	<form action="serachifc.jsp" method="post">
		<input id="search" type="text" name="name" placeholder="검색할 가게명을 입력하세요.">
		<input type="submit" value="검색">
	</form>
		<div class = "image5" style = "background-image:url('image/b1.jpg')"> 
	    </div>
		<div class = "image6" style = "background-image:url('image/b2.jpg')"> 
	   	</div>
		<div class = "image7" style = "background-image:url('image/b3.jpg')"> 
	    </div>
	    <div class="section">
<% 
	...
	String sql = "SELECT cmd,area,name FROM adminifc WHERE name = '" + name + "'";
	...
	while(rs.next()) {
		...
		out.println("층 : "+section+"     번호 : "+area+"      가게이름 : "+nam);
	}
